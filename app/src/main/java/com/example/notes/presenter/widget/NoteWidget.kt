package com.example.notes.presenter.widget
...
class NoteWidget : AppWidgetProvider() {
    companion object {
        @LayoutRes
        const val LAYOUT_RES = R.layout.note_widget
    ...
    override fun onUpdate(
        ...
        getNotesByWidgetIdUseCase?.apply {
            invoke(appWidgetIds.map(Int::toLong))
