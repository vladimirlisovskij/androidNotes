package com.example.notes.cleanArchitecture.view.login
...
import com.example.notes.cleanArchitecture.presenter.login.LoginViewModel
...
class LoginView: BaseView<LoginViewModel>(R.layout.frag_login) {
    ...
    override fun onCreateView(
        ...
        viewModel.loginData.observe(viewLifecycleOwner) {
            auth.signInWithEmailAndPassword(it.email, it.password).addOnCompleteListener(requireActivity(), viewModel::onAuthResult)
        }
